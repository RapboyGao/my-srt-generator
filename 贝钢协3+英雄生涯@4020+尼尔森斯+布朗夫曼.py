...
if __name__ == "__main__":
    ...
    demo_subtitles = [
        ...
        # ----- 第三乐章 -----
        SubtitleItem(timeMinute=27, timeSecond=09.20, text="这个乐章是一首回旋曲，意味着钢琴和乐团的亢奋旋律将多次回归——有时完全相同，有时略有变化。"),
        ...
        SubtitleItem(timeMinute=30, timeSecond=09.26, text="聆听第一双簧管如何将旋律从小调推向大调。这一变化持续片刻，随后乐团果断地回归小调。"),
